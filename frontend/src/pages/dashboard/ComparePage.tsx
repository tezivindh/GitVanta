      ...
      {loading && (
        <Card className="py-12">
          <div className="flex flex-col items-center">
            <Loader size="lg" />
            <p className="mt-4 text-gray-600">Analyzing profiles...</p>
          </div>
        </Card>
      )}
            ...
            <div className="flex items-center justify-around py-8">
              <div className="text-center">
                <ScoreCircle
                  ...
                  label="Your Score"
                />
                <p className="mt-2 font-medium text-gray-900">You</p>
              </div>
                ...
                return (
                  <div key={yourCat.category} className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <div className="text-xs text-gray-500 mb-1">{compareUsername}</div>
                        <ProgressBar
